{
    ...
    "data": [
        ...
        "views/shift_enhanced_views.xml",
        "views/closing_report_views.xml",
        "views/pos_hardware_views.xml",
        ...
        "reports/daily_sales_report.xml",
        "reports/inventory_report.xml",
        "reports/customer_purchase_report.xml",
        "reports/cogs_280e_report.xml",
