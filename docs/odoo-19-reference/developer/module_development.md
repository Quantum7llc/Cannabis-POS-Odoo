# Module Development — Manifest, Structure & Inheritance
...
Module manifest (__manifest__.py), directory structure, inheritance patterns (extension, delegation, prototype), and the module registry. Use when creating or structuring a new Odoo module.
...
:   classification category within Odoo, rough business domain for the module.
    ...
    Although using [existing categories](https://github.com/odoo/odoo/blob/19.0/odoo/addons/base/data/ir_module_category_data.xml) is recommended, the field is
...
:   A definition of how all static files are loaded in various assets bundles.
    See the [assets](../frontend/assets.html#reference-assets) page for more details on how to
    describe bundles.
