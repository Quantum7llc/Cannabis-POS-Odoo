...
> Source: https://github.com/OCA/stock-logistics-workflow/tree/19.0

## Purpose

OCA stock workflow modules: picking split, partial transfer rules, and delivery state management. Use when customising stock operation flows.
...
[stock_dangerous_goods](stock_dangerous_goods/) | 19.0.1.0.0 |  | Adds utility fields to manage dangerous goods
